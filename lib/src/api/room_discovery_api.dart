...
class RoomDiscoveryApi {
  ...
  const RoomDiscoveryApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GetPublicRooms200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetPublicRooms200Response>> getPublicRooms({ 
    int? limit,
    String? since,
    String? server,
    ...
    final _path = r'/_matrix/client/v3/publicRooms';
    ...
    GetPublicRooms200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetPublicRooms200Response),
      ) as GetPublicRooms200Response;
    ...
    return Response<GetPublicRooms200Response>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetRoomVisibilityOnDirectory200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetRoomVisibilityOnDirectory200Response>> getRoomVisibilityOnDirectory({ 
    ...
    final _path = r'/_matrix/client/v3/directory/list/room/{roomId}'.replaceAll('{' r'roomId' '}', encodeQueryParameter(_serializers, roomId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetRoomVisibilityOnDirectory200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetRoomVisibilityOnDirectory200Response),
      ) as GetRoomVisibilityOnDirectory200Response;
    ...
    return Response<GetRoomVisibilityOnDirectory200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [queryPublicRoomsRequest] - Options for which rooms to return.
  /// * [server] - The server to fetch the public room lists from. Defaults to the local server. Case sensitive.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  ...
  /// Returns a [Future] containing a [Response] with a [GetPublicRooms200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetPublicRooms200Response>> queryPublicRooms({ 
    required QueryPublicRoomsRequest queryPublicRoomsRequest,
    String? server,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      const _type = FullType(QueryPublicRoomsRequest);
      _bodyData = _serializers.serialize(queryPublicRoomsRequest, specifiedType: _type);
  ...
  /// Parameters:
  /// * [roomId] - The room ID.
  /// * [setRoomVisibilityOnDirectoryRequest] - The new visibility for the room on the room directory.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> setRoomVisibilityOnDirectory({ 
    required String roomId,
    required SetRoomVisibilityOnDirectoryRequest setRoomVisibilityOnDirectoryRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(SetRoomVisibilityOnDirectoryRequest);
      _bodyData = _serializers.serialize(setRoomVisibilityOnDirectoryRequest, specifiedType: _type);
