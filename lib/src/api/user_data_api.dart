...
class UserDataApi {
  ...
  ///
  /// Parameters:
  /// * [userId] - The id of the user to remove a tag for. The access token must be authorized to make requests for this user ID.
  ...
  Future<Response<JsonObject>> deleteRoomTag({ 
    ...
    final _path = r'/_matrix/client/v3/user/{userId}/rooms/{roomId}/tags/{tag}'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString()).replaceAll('{' r'roomId' '}', encodeQueryParameter(_serializers, roomId, const FullType(String)).toString()).replaceAll('{' r'tag' '}', encodeQueryParameter(_serializers, tag, const FullType(String)).toString());
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> getAccountData({ 
    required String userId,
    ...
    final _path = r'/_matrix/client/v3/user/{userId}/account_data/{type}'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString()).replaceAll('{' r'type' '}', encodeQueryParameter(_serializers, type, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> getAccountDataPerRoom({ 
    required String userId,
    required String roomId,
    required String type,
    CancelToken? cancelToken,
    ...
    final _path = r'/_matrix/client/v3/user/{userId}/rooms/{roomId}/account_data/{type}'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString()).replaceAll('{' r'roomId' '}', encodeQueryParameter(_serializers, roomId, const FullType(String)).toString()).replaceAll('{' r'type' '}', encodeQueryParameter(_serializers, type, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetAvatarUrl200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetAvatarUrl200Response>> getAvatarUrl({ 
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/_matrix/client/v3/profile/{userId}/avatar_url'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetAvatarUrl200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetAvatarUrl200Response),
      ) as GetAvatarUrl200Response;
    ...
    return Response<GetAvatarUrl200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetDisplayName200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetDisplayName200Response>> getDisplayName({ 
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/_matrix/client/v3/profile/{userId}/displayname'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetDisplayName200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetDisplayName200Response),
      ) as GetDisplayName200Response;
    ...
    return Response<GetDisplayName200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetRoomTags200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetRoomTags200Response>> getRoomTags({ 
    required String userId,
    required String roomId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/_matrix/client/v3/user/{userId}/rooms/{roomId}/tags'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString()).replaceAll('{' r'roomId' '}', encodeQueryParameter(_serializers, roomId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetRoomTags200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetRoomTags200Response),
      ) as GetRoomTags200Response;
    ...
    return Response<GetRoomTags200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<GetUserProfile200Response>> getUserProfile({ 
    ...
    final _path = r'/_matrix/client/v3/profile/{userId}'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetUserProfile200Response? _responseData;
    ...
    return Response<GetUserProfile200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> setAccountData({ 
    required String userId,
    required String type,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> setAccountDataPerRoom({ 
    required String userId,
    required String roomId,
    required String type,
    required JsonObject body,
  ...
  /// * [setAvatarUrlRequest] - The new avatar information.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> setAvatarUrl({ 
    required String userId,
    required SetAvatarUrlRequest setAvatarUrlRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(SetAvatarUrlRequest);
      _bodyData = _serializers.serialize(setAvatarUrlRequest, specifiedType: _type);
  ...
  /// * [setDisplayNameRequest] - The new display name information.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> setDisplayName({ 
    required String userId,
    required SetDisplayNameRequest setDisplayNameRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(SetDisplayNameRequest);
      _bodyData = _serializers.serialize(setDisplayNameRequest, specifiedType: _type);
  ...
  /// * [tag] - The tag to add.
  /// * [tag2] - Extra data for the tag, e.g. ordering.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> setRoomTag({ 
    required String userId,
    required String roomId,
    required String tag,
    required Tag tag2,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(tag2, specifiedType: _type);
