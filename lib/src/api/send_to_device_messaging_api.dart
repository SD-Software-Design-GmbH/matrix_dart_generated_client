...
class SendToDeviceMessagingApi {
  ...
  const SendToDeviceMessagingApi(this._dio, this._serializers);
  ...
  Future<Response<JsonObject>> sendToDevice({ 
    ...
    final _path = r'/_matrix/client/v3/sendToDevice/{eventType}/{txnId}'.replaceAll('{' r'eventType' '}', encodeQueryParameter(_serializers, eventType, const FullType(String)).toString()).replaceAll('{' r'txnId' '}', encodeQueryParameter(_serializers, txnId, const FullType(String)).toString());
