...
class ThirdPartyLookupApi {
  ...
  const ThirdPartyLookupApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Protocol] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Protocol>> getProtocolMetadata({ 
    ...
    final _path = r'/_matrix/client/v3/thirdparty/protocol/{protocol}'.replaceAll('{' r'protocol' '}', encodeQueryParameter(_serializers, protocol, const FullType(String)).toString());
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltMap<String, Protocol>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltMap<String, Protocol>>> getProtocols({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/_matrix/client/v3/thirdparty/protocols';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltMap<String, Protocol>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltMap, [FullType(String), FullType(Protocol)]),
      ) as BuiltMap<String, Protocol>;
    ...
    return Response<BuiltMap<String, Protocol>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Location>>> queryLocationByAlias({ 
    ...
    final _path = r'/_matrix/client/v3/thirdparty/location';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [fields] - One or more custom fields to help identify the third-party location.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Location>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Location>>> queryLocationByProtocol({ 
    required String protocol,
    BuiltMap<String, String>? fields,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/_matrix/client/v3/thirdparty/location/{protocol}'.replaceAll('{' r'protocol' '}', encodeQueryParameter(_serializers, protocol, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (fields != null) r'fields': encodeQueryParameter(_serializers, fields, const FullType(BuiltMap, [FullType(String), FullType(String)]), ),
    };
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<User>>> queryUserByID({ 
    ...
    final _path = r'/_matrix/client/v3/thirdparty/user';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<User>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<User>>> queryUserByProtocol({ 
    required String protocol,
    BuiltMap<String, String>? fields,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/_matrix/client/v3/thirdparty/user/{protocol}'.replaceAll('{' r'protocol' '}', encodeQueryParameter(_serializers, protocol, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
