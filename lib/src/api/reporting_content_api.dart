...
class ReportingContentApi {
  ...
  const ReportingContentApi(this._dio, this._serializers);
  ...
  Future<Response<JsonObject>> reportEvent({ 
    required String roomId,
    required String eventId,
    required ReportEventRequest reportEventRequest,
    ...
    final _path = r'/_matrix/client/v3/rooms/{roomId}/report/{eventId}'.replaceAll('{' r'roomId' '}', encodeQueryParameter(_serializers, roomId, const FullType(String)).toString()).replaceAll('{' r'eventId' '}', encodeQueryParameter(_serializers, eventId, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(ReportEventRequest);
      _bodyData = _serializers.serialize(reportEventRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> reportRoom({ 
    required String roomId,
    required ReportRoomRequest reportRoomRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/_matrix/client/v3/rooms/{roomId}/report'.replaceAll('{' r'roomId' '}', encodeQueryParameter(_serializers, roomId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ReportRoomRequest);
      _bodyData = _serializers.serialize(reportRoomRequest, specifiedType: _type);
