...
class SessionManagementApi {
  ...
  const SessionManagementApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GenerateLoginToken200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenerateLoginToken200Response>> generateLoginToken({ 
    required GenerateLoginTokenRequest generateLoginTokenRequest,
    ...
    final _path = r'/_matrix/client/v1/login/get_token';
    ...
    try {
      const _type = FullType(GenerateLoginTokenRequest);
      _bodyData = _serializers.serialize(generateLoginTokenRequest, specifiedType: _type);
    ...
    GenerateLoginToken200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GenerateLoginToken200Response),
      ) as GenerateLoginToken200Response;
    ...
    return Response<GenerateLoginToken200Response>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetLoginFlows200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetLoginFlows200Response>> getLoginFlows({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/_matrix/client/v3/login';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetLoginFlows200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetLoginFlows200Response),
      ) as GetLoginFlows200Response;
    ...
    return Response<GetLoginFlows200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetTokenOwner200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetTokenOwner200Response>> getTokenOwner({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/_matrix/client/v3/account/whoami';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetTokenOwner200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetTokenOwner200Response),
      ) as GetTokenOwner200Response;
    ...
    return Response<GetTokenOwner200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<JsonObject>> logout({ 
    ...
    final _path = r'/_matrix/client/v3/logout';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> logoutAll({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/_matrix/client/v3/logout/all';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> redirectToIdP({ 
    ...
    final _path = r'/_matrix/client/v3/login/sso/redirect/{idpId}'.replaceAll('{' r'idpId' '}', encodeQueryParameter(_serializers, idpId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'redirectUrl': encodeQueryParameter(_serializers, redirectUrl, const FullType(String)),
    };
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> redirectToSSO({ 
    required String redirectUrl,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/_matrix/client/v3/login/sso/redirect';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
