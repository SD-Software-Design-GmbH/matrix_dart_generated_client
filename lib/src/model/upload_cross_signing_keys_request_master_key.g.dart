...
part of 'upload_cross_signing_keys_request_master_key.dart';
...
class _$UploadCrossSigningKeysRequestMasterKey
    extends UploadCrossSigningKeysRequestMasterKey {
  @override
  ...
  factory _$UploadCrossSigningKeysRequestMasterKey(
          [void Function(UploadCrossSigningKeysRequestMasterKeyBuilder)?
              updates]) =>
      (new UploadCrossSigningKeysRequestMasterKeyBuilder()..update(updates))
          ._build();

  _$UploadCrossSigningKeysRequestMasterKey._(
      {required this.keys,
      this.signatures,
      required this.usage,
    ...
    BuiltValueNullFieldError.checkNotNull(
        keys, r'UploadCrossSigningKeysRequestMasterKey', 'keys');
    BuiltValueNullFieldError.checkNotNull(
        usage, r'UploadCrossSigningKeysRequestMasterKey', 'usage');
    BuiltValueNullFieldError.checkNotNull(
        userId, r'UploadCrossSigningKeysRequestMasterKey', 'userId');
  }

  @override
  UploadCrossSigningKeysRequestMasterKey rebuild(
          void Function(UploadCrossSigningKeysRequestMasterKeyBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  UploadCrossSigningKeysRequestMasterKeyBuilder toBuilder() =>
      new UploadCrossSigningKeysRequestMasterKeyBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is UploadCrossSigningKeysRequestMasterKey &&
        keys == other.keys &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'UploadCrossSigningKeysRequestMasterKey')
          ..add('keys', keys)
...
class UploadCrossSigningKeysRequestMasterKeyBuilder
    implements
        Builder<UploadCrossSigningKeysRequestMasterKey,
            UploadCrossSigningKeysRequestMasterKeyBuilder> {
  _$UploadCrossSigningKeysRequestMasterKey? _$v;
  ...
  UploadCrossSigningKeysRequestMasterKeyBuilder() {
    UploadCrossSigningKeysRequestMasterKey._defaults(this);
  }

  UploadCrossSigningKeysRequestMasterKeyBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(UploadCrossSigningKeysRequestMasterKey other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$UploadCrossSigningKeysRequestMasterKey;
  }

  @override
  void update(
      void Function(UploadCrossSigningKeysRequestMasterKeyBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  UploadCrossSigningKeysRequestMasterKey build() => _build();

  _$UploadCrossSigningKeysRequestMasterKey _build() {
    _$UploadCrossSigningKeysRequestMasterKey _$result;
    try {
      _$result = _$v ??
          new _$UploadCrossSigningKeysRequestMasterKey._(
            keys: keys.build(),
