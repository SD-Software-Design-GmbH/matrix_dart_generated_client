...
part 'upload_cross_signing_keys_request_user_signing_key.g.dart';
...
@BuiltValue()
abstract class UploadCrossSigningKeysRequestUserSigningKey implements Built<UploadCrossSigningKeysRequestUserSigningKey, UploadCrossSigningKeysRequestUserSigningKeyBuilder> {
  ...
  UploadCrossSigningKeysRequestUserSigningKey._();

  factory UploadCrossSigningKeysRequestUserSigningKey([void updates(UploadCrossSigningKeysRequestUserSigningKeyBuilder b)]) = _$UploadCrossSigningKeysRequestUserSigningKey;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UploadCrossSigningKeysRequestUserSigningKeyBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UploadCrossSigningKeysRequestUserSigningKey> get serializer => _$UploadCrossSigningKeysRequestUserSigningKeySerializer();
}

class _$UploadCrossSigningKeysRequestUserSigningKeySerializer implements PrimitiveSerializer<UploadCrossSigningKeysRequestUserSigningKey> {
  @override
  final Iterable<Type> types = const [UploadCrossSigningKeysRequestUserSigningKey, _$UploadCrossSigningKeysRequestUserSigningKey];

  @override
  final String wireName = r'UploadCrossSigningKeysRequestUserSigningKey';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UploadCrossSigningKeysRequestUserSigningKey object, {
  ...
  void _deserializeProperties(
    ...
    required UploadCrossSigningKeysRequestUserSigningKeyBuilder result,
  ...
  @override
  UploadCrossSigningKeysRequestUserSigningKey deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UploadCrossSigningKeysRequestUserSigningKeyBuilder();
