...
part of 'room_filter_ephemeral.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$RoomFilterEphemeral extends RoomFilterEphemeral {
  @override
  final int? limit;
  @override
  ...
  factory _$RoomFilterEphemeral(
          [void Function(RoomFilterEphemeralBuilder)? updates]) =>
      (new RoomFilterEphemeralBuilder()..update(updates))._build();

  _$RoomFilterEphemeral._(
      {this.limit,
      this.notSenders,
      this.notTypes,
      this.senders,
  ...
  @override
  RoomFilterEphemeral rebuild(
          void Function(RoomFilterEphemeralBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RoomFilterEphemeralBuilder toBuilder() =>
      new RoomFilterEphemeralBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RoomFilterEphemeral &&
        limit == other.limit &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RoomFilterEphemeral')
          ..add('limit', limit)
...
class RoomFilterEphemeralBuilder
    implements Builder<RoomFilterEphemeral, RoomFilterEphemeralBuilder> {
  _$RoomFilterEphemeral? _$v;
  ...
  RoomFilterEphemeralBuilder() {
    RoomFilterEphemeral._defaults(this);
  }

  RoomFilterEphemeralBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _limit = $v.limit;
  ...
  @override
  void replace(RoomFilterEphemeral other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$RoomFilterEphemeral;
  }

  @override
  void update(void Function(RoomFilterEphemeralBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RoomFilterEphemeral build() => _build();

  _$RoomFilterEphemeral _build() {
    _$RoomFilterEphemeral _$result;
    try {
      _$result = _$v ??
          new _$RoomFilterEphemeral._(
            limit: limit,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'RoomFilterEphemeral', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
