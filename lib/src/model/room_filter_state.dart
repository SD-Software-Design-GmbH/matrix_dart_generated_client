...
@BuiltValue()
abstract class RoomFilterState implements Built<RoomFilterState, RoomFilterStateBuilder> {
  ...
  factory RoomFilterState([void updates(RoomFilterStateBuilder b)]) = _$RoomFilterState;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RoomFilterStateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RoomFilterState> get serializer => _$RoomFilterStateSerializer();
}

class _$RoomFilterStateSerializer implements PrimitiveSerializer<RoomFilterState> {
  @override
  final Iterable<Type> types = const [RoomFilterState, _$RoomFilterState];

  @override
  final String wireName = r'RoomFilterState';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RoomFilterState object, {
  ...
  void _deserializeProperties(
    ...
    required RoomFilterStateBuilder result,
  ...
  @override
  RoomFilterState deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RoomFilterStateBuilder();
