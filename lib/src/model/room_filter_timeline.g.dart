...
part of 'room_filter_timeline.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$RoomFilterTimeline extends RoomFilterTimeline {
  @override
  final int? limit;
  @override
  ...
  factory _$RoomFilterTimeline(
          [void Function(RoomFilterTimelineBuilder)? updates]) =>
      (new RoomFilterTimelineBuilder()..update(updates))._build();

  _$RoomFilterTimeline._(
      {this.limit,
      this.notSenders,
      this.notTypes,
      this.senders,
  ...
  @override
  RoomFilterTimeline rebuild(
          void Function(RoomFilterTimelineBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RoomFilterTimelineBuilder toBuilder() =>
      new RoomFilterTimelineBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RoomFilterTimeline &&
        limit == other.limit &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RoomFilterTimeline')
          ..add('limit', limit)
...
class RoomFilterTimelineBuilder
    implements Builder<RoomFilterTimeline, RoomFilterTimelineBuilder> {
  _$RoomFilterTimeline? _$v;
  ...
  RoomFilterTimelineBuilder() {
    RoomFilterTimeline._defaults(this);
  }

  RoomFilterTimelineBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _limit = $v.limit;
  ...
  @override
  void replace(RoomFilterTimeline other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$RoomFilterTimeline;
  }

  @override
  void update(void Function(RoomFilterTimelineBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RoomFilterTimeline build() => _build();

  _$RoomFilterTimeline _build() {
    _$RoomFilterTimeline _$result;
    try {
      _$result = _$v ??
          new _$RoomFilterTimeline._(
            limit: limit,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'RoomFilterTimeline', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
