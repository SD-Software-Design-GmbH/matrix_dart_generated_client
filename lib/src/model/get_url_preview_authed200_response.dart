...
/// * [ogColonImage] - An [`mxc://` URI](https://spec.matrix.org/v1.13/client-server-api/#matrix-content-mxc-uris) to the image. Omitted if there is no image.
@BuiltValue()
abstract class GetUrlPreviewAuthed200Response implements Built<GetUrlPreviewAuthed200Response, GetUrlPreviewAuthed200ResponseBuilder> {
  ...
  /// An [`mxc://` URI](https://spec.matrix.org/v1.13/client-server-api/#matrix-content-mxc-uris) to the image. Omitted if there is no image.
