...
/// * [underride] 
@BuiltValue()
abstract class Ruleset implements Built<Ruleset, RulesetBuilder> {
  ...
  factory Ruleset([void updates(RulesetBuilder b)]) = _$Ruleset;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RulesetBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<Ruleset> get serializer => _$RulesetSerializer();
}

class _$RulesetSerializer implements PrimitiveSerializer<Ruleset> {
  @override
  final Iterable<Type> types = const [Ruleset, _$Ruleset];

  @override
  final String wireName = r'Ruleset';
  ...
  void _deserializeProperties(
    ...
    required RulesetBuilder result,
