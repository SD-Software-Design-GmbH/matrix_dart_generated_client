...
part 'room_filter_ephemeral.g.dart';
...
@BuiltValue()
abstract class RoomFilterEphemeral implements Built<RoomFilterEphemeral, RoomFilterEphemeralBuilder> {
  ...
  RoomFilterEphemeral._();

  factory RoomFilterEphemeral([void updates(RoomFilterEphemeralBuilder b)]) = _$RoomFilterEphemeral;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RoomFilterEphemeralBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RoomFilterEphemeral> get serializer => _$RoomFilterEphemeralSerializer();
}

class _$RoomFilterEphemeralSerializer implements PrimitiveSerializer<RoomFilterEphemeral> {
  @override
  final Iterable<Type> types = const [RoomFilterEphemeral, _$RoomFilterEphemeral];

  @override
  final String wireName = r'RoomFilterEphemeral';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RoomFilterEphemeral object, {
  ...
  void _deserializeProperties(
    ...
    required RoomFilterEphemeralBuilder result,
  ...
  @override
  RoomFilterEphemeral deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RoomFilterEphemeralBuilder();
