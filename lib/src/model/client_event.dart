...
@BuiltValue()
abstract class ClientEvent implements Built<ClientEvent, ClientEventBuilder> {
  ...
  factory ClientEvent([void updates(ClientEventBuilder b)]) = _$ClientEvent;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ClientEventBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ClientEvent> get serializer => _$ClientEventSerializer();
}

class _$ClientEventSerializer implements PrimitiveSerializer<ClientEvent> {
  @override
  final Iterable<Type> types = const [ClientEvent, _$ClientEvent];

  @override
  final String wireName = r'ClientEvent';
  ...
  void _deserializeProperties(
    ...
    required ClientEventBuilder result,
  ...
  @override
  ClientEvent deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ClientEventBuilder();
