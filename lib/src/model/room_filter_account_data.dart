...
part 'room_filter_account_data.g.dart';
...
@BuiltValue()
abstract class RoomFilterAccountData implements Built<RoomFilterAccountData, RoomFilterAccountDataBuilder> {
  ...
  RoomFilterAccountData._();

  factory RoomFilterAccountData([void updates(RoomFilterAccountDataBuilder b)]) = _$RoomFilterAccountData;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RoomFilterAccountDataBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RoomFilterAccountData> get serializer => _$RoomFilterAccountDataSerializer();
}

class _$RoomFilterAccountDataSerializer implements PrimitiveSerializer<RoomFilterAccountData> {
  @override
  final Iterable<Type> types = const [RoomFilterAccountData, _$RoomFilterAccountData];

  @override
  final String wireName = r'RoomFilterAccountData';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RoomFilterAccountData object, {
  ...
  void _deserializeProperties(
    ...
    required RoomFilterAccountDataBuilder result,
  ...
  @override
  RoomFilterAccountData deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RoomFilterAccountDataBuilder();
