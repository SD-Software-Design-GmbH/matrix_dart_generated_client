...
part of 'room_filter_account_data.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$RoomFilterAccountData extends RoomFilterAccountData {
  @override
  final int? limit;
  @override
  ...
  factory _$RoomFilterAccountData(
          [void Function(RoomFilterAccountDataBuilder)? updates]) =>
      (new RoomFilterAccountDataBuilder()..update(updates))._build();

  _$RoomFilterAccountData._(
      {this.limit,
      this.notSenders,
      this.notTypes,
      this.senders,
  ...
  @override
  RoomFilterAccountData rebuild(
          void Function(RoomFilterAccountDataBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RoomFilterAccountDataBuilder toBuilder() =>
      new RoomFilterAccountDataBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RoomFilterAccountData &&
        limit == other.limit &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RoomFilterAccountData')
          ..add('limit', limit)
...
class RoomFilterAccountDataBuilder
    implements Builder<RoomFilterAccountData, RoomFilterAccountDataBuilder> {
  _$RoomFilterAccountData? _$v;
  ...
  RoomFilterAccountDataBuilder() {
    RoomFilterAccountData._defaults(this);
  }

  RoomFilterAccountDataBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _limit = $v.limit;
  ...
  @override
  void replace(RoomFilterAccountData other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$RoomFilterAccountData;
  }

  @override
  void update(void Function(RoomFilterAccountDataBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RoomFilterAccountData build() => _build();

  _$RoomFilterAccountData _build() {
    _$RoomFilterAccountData _$result;
    try {
      _$result = _$v ??
          new _$RoomFilterAccountData._(
            limit: limit,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'RoomFilterAccountData', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
