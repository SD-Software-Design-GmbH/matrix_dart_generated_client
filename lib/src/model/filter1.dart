...
/// This takes a [filter](https://spec.matrix.org/v1.13/client-server-api/#filtering).
///
/// Properties:
...
@BuiltValue()
abstract class Filter1 implements Built<Filter1, Filter1Builder> {
  ...
  factory Filter1([void updates(Filter1Builder b)]) = _$Filter1;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(Filter1Builder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<Filter1> get serializer => _$Filter1Serializer();
}

class _$Filter1Serializer implements PrimitiveSerializer<Filter1> {
  @override
  final Iterable<Type> types = const [Filter1, _$Filter1];

  @override
  final String wireName = r'Filter1';
  ...
  void _deserializeProperties(
    ...
    required Filter1Builder result,
