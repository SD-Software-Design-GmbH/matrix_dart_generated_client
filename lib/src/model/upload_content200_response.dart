...
///
/// Properties:
/// * [contentUri] - The [`mxc://` URI](https://spec.matrix.org/v1.13/client-server-api/#matrix-content-mxc-uris) to the uploaded content.
@BuiltValue()
abstract class UploadContent200Response implements Built<UploadContent200Response, UploadContent200ResponseBuilder> {
  /// The [`mxc://` URI](https://spec.matrix.org/v1.13/client-server-api/#matrix-content-mxc-uris) to the uploaded content.
