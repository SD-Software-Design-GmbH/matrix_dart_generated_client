...
part 'get_relating_events_with_rel_type_and_event_type200_response.g.dart';
...
/// * [chunk] - The child events of the requested event, ordered topologically most-recent first. The events returned will match the `relType` and `eventType` supplied in the URL.
@BuiltValue()
abstract class GetRelatingEventsWithRelTypeAndEventType200Response implements Built<GetRelatingEventsWithRelTypeAndEventType200Response, GetRelatingEventsWithRelTypeAndEventType200ResponseBuilder> {
  ...
  GetRelatingEventsWithRelTypeAndEventType200Response._();

  factory GetRelatingEventsWithRelTypeAndEventType200Response([void updates(GetRelatingEventsWithRelTypeAndEventType200ResponseBuilder b)]) = _$GetRelatingEventsWithRelTypeAndEventType200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GetRelatingEventsWithRelTypeAndEventType200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GetRelatingEventsWithRelTypeAndEventType200Response> get serializer => _$GetRelatingEventsWithRelTypeAndEventType200ResponseSerializer();
}

class _$GetRelatingEventsWithRelTypeAndEventType200ResponseSerializer implements PrimitiveSerializer<GetRelatingEventsWithRelTypeAndEventType200Response> {
  @override
  final Iterable<Type> types = const [GetRelatingEventsWithRelTypeAndEventType200Response, _$GetRelatingEventsWithRelTypeAndEventType200Response];

  @override
  final String wireName = r'GetRelatingEventsWithRelTypeAndEventType200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    GetRelatingEventsWithRelTypeAndEventType200Response object, {
  ...
  void _deserializeProperties(
    ...
    required GetRelatingEventsWithRelTypeAndEventType200ResponseBuilder result,
  ...
  @override
  GetRelatingEventsWithRelTypeAndEventType200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = GetRelatingEventsWithRelTypeAndEventType200ResponseBuilder();
