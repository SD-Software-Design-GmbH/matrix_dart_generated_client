...
// tests for UploadCrossSigningKeysRequestSelfSigningKey
void main() {
  final instance = UploadCrossSigningKeysRequestSelfSigningKeyBuilder();
  // TODO add properties to the builder and call build()

  group(UploadCrossSigningKeysRequestSelfSigningKey, () {
