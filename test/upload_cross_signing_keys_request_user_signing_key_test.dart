...
// tests for UploadCrossSigningKeysRequestUserSigningKey
void main() {
  final instance = UploadCrossSigningKeysRequestUserSigningKeyBuilder();
  // TODO add properties to the builder and call build()

  group(UploadCrossSigningKeysRequestUserSigningKey, () {
