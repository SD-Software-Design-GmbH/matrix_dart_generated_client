...
// tests for GetRelatingEventsWithRelType200Response
void main() {
  final instance = GetRelatingEventsWithRelType200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(GetRelatingEventsWithRelType200Response, () {
